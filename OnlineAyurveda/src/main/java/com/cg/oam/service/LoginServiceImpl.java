...
import com.cg.oam.dao.ILoginDao;
...
public class LoginServiceImpl implements ILoginService {
	 ...
	 */
	@Override
	public Login doLogin(Integer customerId, String password) throws LoginException {
		Login login = null;
		System.out.println(customerId);
		logger.debug("doing login process");
		Optional<Login> optLogin = logindao.findById(customerId);
		System.out.println(password);
		//System.out.println(optLogin.get());
	...
	public String encryptLogin(Login loginAcnt) {
		return encryptString(loginAcnt.getCustomerId().toString()) + "-" + encryptString(loginAcnt.getRole());
	}
